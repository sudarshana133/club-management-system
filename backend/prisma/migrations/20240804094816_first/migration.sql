...
-- CreateIndex
CREATE UNIQUE INDEX "User_clubName_key" ON "User"("clubName");
...
-- AddForeignKey
ALTER TABLE "Club" ADD CONSTRAINT "Club_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "User"("uId") ON DELETE RESTRICT ON UPDATE CASCADE;
